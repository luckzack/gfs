...
func (s *HTTPStaticServer) hIndex(w http.ResponseWriter, r *http.Request) {
	...
	if gcfg.Namespace {
		...
		namespace := ns.Get(user)
		if namespace == nil {
			http.Error(w, "Delete forbidden", http.StatusForbidden)
			return
		}
		//log.Println("#######", r.FormValue("raw"), namespace.Dir, path)
	}
...
func (s *HTTPStaticServer) hUpload(w http.ResponseWriter, req *http.Request) {
	...
	if gcfg.Namespace {
		...
		dirpath = filepath.Join(s.Root, namespace.Dir, path)
	} else {
...
func (s *HTTPStaticServer) hJSONList(w http.ResponseWriter, r *http.Request) {
	...
	if gcfg.Namespace {
		...
		localPath = filepath.Join(s.Root, namespace.Dir, requestPath)
		//log.Println("#######", r.FormValue("raw"), namespace.Dir, path)
	}
